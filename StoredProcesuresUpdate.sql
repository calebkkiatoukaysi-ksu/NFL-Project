...
-- =====================================
CREATE PROCEDURE NFL.InsertConference
...
-- =====================================
CREATE PROCEDURE NFL.UpdateConference
    @CONFERENCEID INT,
    @NEWNAME NVARCHAR(50)
AS
BEGIN
    UPDATE NFL.Conference
...
-- =====================================
CREATE PROCEDURE NFL.InsertDivision
...
-- =====================================
CREATE PROCEDURE NFL.UpdateDivision
    @DIVISIONID INT,
    @NEWNAME NVARCHAR(50),
    @NEWCONFERENCEID INT
AS
BEGIN
    UPDATE NFL.Division
    SET DivisionName = @NEWNAME, ConferenceID = @NEWCONFERENCEID
